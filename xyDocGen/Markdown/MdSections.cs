...
#nullable enable
    internal class MdSections
    {
        ...
        /// <param name="dic_AnchorMap_"></param>
        internal static void RenderMetadata(StringBuilder sb_MarkdownBuilder_, TypeDoc td_TargetType_, int level_, Dictionary<string, string> dic_AnchorMap_)
        {
        ...
        /// <param name="level_">The heading level for the Markdown output.</param>
        /// <param name="dic_AnchorMap_"></param>
        internal static void RenderNestedTypes(StringBuilder sb_MarkdownRenderer, TypeDoc td_TargetType_, int level_, Dictionary<string, string> dic_AnchorMap_)
        {
        ...
        /// <returns></returns>
        internal static string FormatSignatureWithLinks(string signature_, Dictionary<string, string> dic_AnchorIdMapping_)
        {
