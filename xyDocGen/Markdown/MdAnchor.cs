...
namespace xyDocumentor.Markdown
{
    internal class MdAnchor
    {
        ...
        /// <returns></returns>
        internal static string GetUniqueTypeName(TypeDoc td_TargetType) => !string.IsNullOrWhiteSpace(td_TargetType.Namespace) ? $"{td_TargetType.Namespace}.{td_TargetType.DisplayName}" : $"Global (Default).{td_TargetType.DisplayName}";
        ...
        internal static string GetAnchorIDFromTypeName(string name_)
        {
        ...
        /// <returns></returns>
        internal static Dictionary<string, string> BuildAnchorMap(TypeDoc td_RootType_)
        {
        ...
        internal static Dictionary<string, string> BuildAnchorAliasMap(Dictionary<string, string> anchorMap)
        {
