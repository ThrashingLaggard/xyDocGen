...
#nullable enable
    ...
    internal class MdMembersTable
    {
        ...
        internal static void RenderAllMembers(StringBuilder sb_Markdownbuilder_, TypeDoc td_TargetObject_, int level_, Dictionary<string, string> dic_AnchorMap_)
        {
        ...
        /// <param name="dic_AnchorMap_"></param>
        internal static void RenderMembersAsTable(StringBuilder sb_MarkdownBuilder_, string title_, IReadOnlyList<MemberDoc> listedMembers_, int level, Dictionary<string, string> dic_AnchorMap_)
        {
        ...
        /// </summary>
        internal static void RenderTableOfContents(StringBuilder sb, TypeDoc root, Dictionary<string, string> anchorMap)
        {
