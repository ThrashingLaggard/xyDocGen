...
namespace xyDocumentor.Pdf_Layout
{
    internal class PdfHeaderFooterLayout
    {
        ...
        internal void DrawHeaderFooterArea()
        {
            ...
            double headerLH = _pw.Theme.LineHeight(headerFont); 
            double footerLH = _pw.Theme.LineHeight(footerFont);

            double headerBottom = _pw._top - 2;                 
            double headerTop = Math.Max(6, _pw._top - 2 - headerLH);  
            ...
            double pageHeight = _pw.Page.Height;                    
